    ...
    for road_key in map_dict:
        for lane_key in map_dict[road_key]:
            ...
            for i in range(0, len(lane["waypoints"])):
                ...
                waypoints_graph[str(map_dict[road_key][lane_key]["waypoints"][i].id)] = waypoint_dict
...
def get_dynamic_objects(carla_world, carla_map):
    ...
    def get_stop_signals(stops):
        ...
        for stop in stops:
            ...
            stop_signals_dict[str(stop.id)] = st_dict
    ...
    def get_traffic_lights(traffic_lights):
        ...
        for traffic_light in traffic_lights:
            ...
            traffic_lights_dict[str(traffic_light.id)] = tl_dict
    ...
    def get_vehicles(vehicles):
        ...
        for vehicle in vehicles:
            ...
            vehicles_dict[str(vehicle.id)] = v_dict
    ...
    def get_walkers(walkers):
        ...
        for walker in walkers:
            ...
            walkers_dict[str(walker.id)] = w_dict
        return walkers_dict
    ...
    def get_speed_limits(speed_limits):
        ...
        for speed_limit in speed_limits:
            ...
            speed_limits_dict[str(speed_limit.id)] = sl_dict
    ...
    def get_static_obstacles(static_obstacles):
        ...
        for static_prop in static_obstacles:
            ...
            static_obstacles_dict[str(static_prop.id)] = sl_dict
...
print(get_scene_layout(m))
print(get_dynamic_objects(world,m))
