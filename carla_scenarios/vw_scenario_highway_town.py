...
from srunner.scenariomanager.scenarioatomics.atomic_behaviors import WaypointFollower, StopVehicle, Idle, ActorDestroy
...
class VwScenarioHighwayTown(BasicScenario):
    """
    ...
    def __init__(self, world, ego_vehicles, config, terminate_on_failure=False, debug_mode=False, criteria_enable=True,
       ...
       """
        ...
        super(VwScenarioHighwayTown, self).__init__(
            self.scenario_name,
            ego_vehicles,
            config,
            world,
    ...
    def _create_test_criteria(self) -> List[Criterion]:
        ...
        loc = carla.Location(57.0687, 94.1012, 0)
        dist = 2.0
        criteria = [CollisionTest(self.ego_vehicles[0]),
                    ...
                    MonitorEgoVehicle(actor=self.ego_vehicles[0], world=self._world, debug_mode=self._debug_mode,
                                      generate_static_map_info=False, noise=NoiseData([NoiseTypeEnum.POSITION_NOISE],
                                                                                      NoiseTargetEnum.ALL, 0.0, 0.3, 2),
                                      scenario_name=self.scenario_name),
                    MonitorEgoVehicle(actor=self.ego_vehicles[0], world=self._world, debug_mode=self._debug_mode,
                                      generate_static_map_info=False, noise=NoiseData([NoiseTypeEnum.POSITION_NOISE],
                                                                                      NoiseTargetEnum.ALL, 0.0, 0.4, 2),
                                      scenario_name=self.scenario_name),
                    MonitorEgoVehicle(actor=self.ego_vehicles[0], world=self._world, debug_mode=self._debug_mode,
                                      generate_static_map_info=False, noise=NoiseData([NoiseTypeEnum.POSITION_NOISE],
    ...
    def get_ego_behavior(self) -> Behaviour:
        ...
        ego_sequence.add_child(WaypointFollower(self.ego_vehicles[0], 10, self.scenario_helper.get_waypoint_plan([
            (carla.Location(-10.26474, 205.09, 0), RoadOption.CHANGELANELEFT),
            (carla.Location(0.78583, 201.73, 0), RoadOption.STRAIGHT),
            (carla.Location(6.4458, 201.59, 0), RoadOption.STRAIGHT),
            (carla.Location(8.4458, 202.59, 0), RoadOption.STRAIGHT)]), avoid_collision=True)),
        ego_sequence.add_child(StopVehicle(self.ego_vehicles[0], 25, ))
        ego_sequence.add_child(Idle(3))
        ego_sequence.add_child(WaypointFollower(self.ego_vehicles[0], 10, self.scenario_helper.get_waypoint_plan([
            (carla.Location(15.1288, 202.221, 0), RoadOption.LEFT),
            (carla.Location(20.4243, 201.449, 0), RoadOption.STRAIGHT),
            (carla.Location(24.3076, 198.855, 0), RoadOption.STRAIGHT),
            (carla.Location(28.1909, 195.137, 0), RoadOption.STRAIGHT),
            (carla.Location(29.8855, 190.789, 0), RoadOption.STRAIGHT),
            (carla.Location(31.3682, 187.703, 0), RoadOption.STRAIGHT),
            (carla.Location(31.6506, 184.267, 0), RoadOption.STRAIGHT),
            (carla.Location(31.7918, 181.461, 0), RoadOption.STRAIGHT),
            (carla.Location(31.5094, 177.183, 0), RoadOption.STRAIGHT),
            (carla.Location(31.3682, 156.003, 0), RoadOption.STRAIGHT),
            (carla.Location(33.3099, 130.205, 0), RoadOption.CHANGELANERIGHT),
            (carla.Location(33.3099, 128.205, 0), RoadOption.CHANGELANERIGHT),
            (carla.Location(35.0985, 126.465, 0), RoadOption.CHANGELANERIGHT),
            (carla.Location(35.0985, 114.465, 0), RoadOption.STRAIGHT),
            (carla.Location(35.0985, 112.465, 0), RoadOption.STRAIGHT),
            (carla.Location(35.0985, 110.233, 0), RoadOption.STRAIGHT)]), avoid_collision=True)),
        ego_sequence.add_child(StopVehicle(self.ego_vehicles[0], 20, ))
        ego_sequence.add_child(Idle(2))
        ego_sequence.add_child(WaypointFollower(self.ego_vehicles[0], 10, self.scenario_helper.get_waypoint_plan([
            (carla.Location(35.2868, 102.941, 0), RoadOption.RIGHT),
            (carla.Location(34.9161, 100.364, 0), RoadOption.STRAIGHT),
            (carla.Location(35.4986, 98.4705, 0), RoadOption.STRAIGHT),
            (carla.Location(36.5577, 96.8925, 0), RoadOption.STRAIGHT),
            (carla.Location(39.4173, 95.3145, 0), RoadOption.STRAIGHT),
            (carla.Location(44.0243, 95.1567, 0), RoadOption.STRAIGHT),
            (carla.Location(45.7718, 95.3671, 0), RoadOption.STRAIGHT),
            (carla.Location(56.045, 95.4723, 0), RoadOption.STRAIGHT),
            (carla.Location(65.6827, 94.5255, 0), RoadOption.STRAIGHT),
            (carla.Location(70.2897, 93.4209, 0), RoadOption.STRAIGHT)]), avoid_collision=True)),
   ...
   """
    ...
    t2_sequence.add_child(WaypointFollower(veh1, 5,
                                           self.scenario_helper.get_waypoint_plan(locations=[
                                               (carla.Location(99.0952, 209.314, 0), RoadOption.STRAIGHT)]),
    ...
    citreon_sequence.add_child(WaypointFollower(veh2, 7,
                                                self.scenario_helper.get_waypoint_plan(locations=[
                                                    (carla.Location(99.3335, 202.449, 0), RoadOption.STRAIGHT)]),
                                                avoid_collision=True))
